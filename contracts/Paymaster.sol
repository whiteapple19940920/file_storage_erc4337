...
contract Paymaster is Ownable, IPaymaster {
    ...
    modifier onlyEntryPoint() {
        require(msg.sender == address(entryPoint), "Only entryPoint can call this method");
        _;
    }
    ...
    function validatePaymasterUserOp(UserOperation calldata userOp, bytes32 userOpHash, uint256 maxCost) external view override returns (bytes memory context, uint256 deadline) {
